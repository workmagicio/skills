basic_read output template — single scenario reading:

<callout emoji="📊">
**{Scenario name} — top moves**
- **{Channel}: {direction} {%} ({\$baseline} → {\$recommended})**  
*Why*: {saturation-curve framing — marginal ROAS, headroom or saturation}.  
*Impact*: {contribution to expected lift or saved spend}.
